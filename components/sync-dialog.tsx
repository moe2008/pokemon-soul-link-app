...
import { Copy, Download, Upload, Share2, Check, AlertCircle } from "lucide-react"
...
export function SyncDialog({ data, onImportData }: SyncDialogProps) {
  ...
  const handleDownload = () => {
    ...
    a.href = url
    a.download = `pokemon-soullink-${new Date().toISOString().split("T")[0]}.json`
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Export your progress to share with friends or import data from your Soullink partner
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="export" className="space-y-4">
          ...
          <TabsContent value="export" className="space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Copy this data and send it to your Soullink partner, or save it as a backup
              </p>
          ...
          <TabsContent value="import" className="space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Paste your partner's exported data or upload a file to sync your progress
              </p>
          ...
          <TabsContent value="share" className="space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Generate a shareable link that contains your current progress
              </p>

              <Alert>
                <AlertCircle className="h-4 w-4" />
                <AlertDescription>
                  The link contains your complete progress data. Only share with trusted friends.
                </AlertDescription>
              </Alert>
